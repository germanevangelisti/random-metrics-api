...
// export async function shootAlerts() {
//     const metricSources = generateRandomMetricValue(metricSourcesData)
//     // const alerts = await Alert.find().lean().exec((err, alerts) => alerts)
